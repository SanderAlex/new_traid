...
set :application, "aaa"
set :repository,  "git@github.com:SanderAlex/titan-traid.git"
...
set :unicorn_conf, "/etc/unicorn/titantraid.spiritd.rb"
set :unicorn_pid, "/var/run/unicorn/titantraid.spiritd.pid"
